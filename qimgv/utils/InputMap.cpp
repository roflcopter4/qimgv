...
QMap<quint32, QString> const &InputMap::keys()
{
    return keyMap;
}

QMap<QString, Qt::KeyboardModifier> const &InputMap::modifiers()
{
    return modMap;
}
...
void InputMap::initKeyMap()
{
    ...
    // special
    // keyMap.insert(?? , QS("Wake Up"); // "Fn") key on thinkpad
    ...
    keyMap.insert(57426, QS("Ins"));
    keyMap.insert(57415, QS("Home"));
    keyMap.insert(57417, QS("PgUp"));
    keyMap.insert(57427, QS("Del"));
    keyMap.insert(57423, QS("End"));
    keyMap.insert(57425, QS("PgDown"));
    keyMap.insert(57416, QS("Up"));
    keyMap.insert(57437, QS("Menu"));
    keyMap.insert(57419, QS("Left"));
    keyMap.insert(57424, QS("Down"));
    keyMap.insert(57421, QS("Right"));
    // numpad
    keyMap.insert(57413, QS("NumLock"));
    keyMap.insert(57397, QS("/"));
    keyMap.insert(57372, QS("Enter"));
